...
enum class StringKey(val defaultValue: String) {
    ...
    SettingsLocalLogosTitle("Local channel logos"),
    SettingsLocalLogosHint("Choose a folder (USB or internal storage) with PNG files named after the tvg-id or channel name. Files in the folder replace provider logos on screen."),
...
class Strings(
    ...
    val settingsLocalLogosTitle: String get() = overrides[StringKey.SettingsLocalLogosTitle] ?: StringKey.SettingsLocalLogosTitle.defaultValue
    val settingsLocalLogosHint: String get() = overrides[StringKey.SettingsLocalLogosHint] ?: StringKey.SettingsLocalLogosHint.defaultValue
    val settingsChooseFolder: String get() = overrides[StringKey.SettingsChooseFolder] ?: StringKey.SettingsChooseFolder.defaultValue
    val settingsChangeFolder: String get() = overrides[StringKey.SettingsChangeFolder] ?: StringKey.SettingsChangeFolder.defaultValue
...
private val ES: Strings by lazy {
    stringsOf {
        ...
        put(StringKey.NavSeries, "Series")
        ...
        put(StringKey.CategoriesHideAdult, "🔞 Ocultar adultas")
        ...
        put(StringKey.SettingsResync, "Sincronizar de nuevo")
        put(StringKey.SettingsBackupTitle, "💾 Copia y restauración")
        put(StringKey.SettingsBackupHint, "Exporta proveedores, favoritos e historial a un JSON que elijas. Los catálogos (canales / películas / series) se vuelven a descargar durante la sincronización, no se incluyen.")
        put(StringKey.SettingsBackupExport, "Exportar copia")
        put(StringKey.SettingsBackupImport, "Importar copia…")
        put(StringKey.SettingsLocalLogosTitle, "Logos locales de canales")
        put(StringKey.SettingsLocalLogosHint, "Elige una carpeta (USB o almacenamiento interno) con archivos PNG nombrados según el tvg-id o el nombre del canal. Los archivos de la carpeta reemplazan los logos del proveedor en la pantalla.")
        put(StringKey.SettingsChooseFolder, "Elegir carpeta")
        put(StringKey.SettingsChangeFolder, "Cambiar carpeta")
        put(StringKey.SettingsParentalHint, "Cuando hay un PIN, las categorías adultas (xxx / adult / 18+ / etc.) se bloquean en cada sincronización.")
        ...
        put(StringKey.SettingsAutoSync, "Sincronización automática al inicio")
        ...
        put(StringKey.SearchAll, "Todo")
        put(StringKey.SearchChannels, "Canales")
        put(StringKey.SearchSport, "Deportes")
        put(StringKey.SearchDocumentary, "Documentales")
        put(StringKey.SearchResume, "Continuar")
